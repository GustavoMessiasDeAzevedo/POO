...
namespace _17_Calendario
{
    internal class Calendario
    {
        ...
        private List<Feriado> RetornaFeriados()
        {
            ...
            else if (mes == Mes.Setembro) feriados.Add(new Feriado(9, "Independência do Brasil"));
            else if (mes == Mes.Outubro) feriados.Add(new Feriado(12, "Dia de Nossa Senhora da Aparecida"));
