    ...
    internal class Calendario
    {
        ...
        public void ImprimirCalendario()
        {
            ...
            foreach (Feriado diaFeriado in diasFeriados)
            {
                if (diaFeriado != null)
                {
                    Console.Write($"{diaFeriado.Dia.ToString("D2")} - {diaFeriado.Descricao}\t");
                }
            }
        }
        ...
        private Feriado[] RetornaFeriados()
        {
            ...
            else if (mes == 7) feriados[indice++] = new Feriado(1, "Revolução constitucionalista de São paulo");
            else if (mes == 9) feriados[indice++] = new Feriado(9, "Independência do Brasil");
            else if (mes == 10) feriados[indice++] = new Feriado(12, "Dia de Nossa Senhora da Aparecida");
            else if (mes == 11)
            {
